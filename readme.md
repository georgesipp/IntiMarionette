...
Die Achsen des BNO055 lassen sich mit den Registern AXIS_MAP_CONFIG und AXIS_MAP_SIGN neu zuordnen. Die Standard-Achseneinstellung ist auf dem BNO055 verzeichnet (Abb. 3). | <img src="https://github.com/georgesipp/IntiMarionette/blob/main/images/bno1.png"  width="250">
Wenn der Sensor waagerecht und auf der Y-Achse Richtung Norden ausgerichtet ist, zeigt der Sensor auf den absoluten Nullpunkt. |
-|-
Bei der Inti-Marionette sind die Sensoren auf der Rückseite angebracht, die Achsen müssen also neu zugeordnet werden. | <img src="https://github.com/georgesipp/IntiMarionette/blob/main/images/bno2.png"  width="250">
